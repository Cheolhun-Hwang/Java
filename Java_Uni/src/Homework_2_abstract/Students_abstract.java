...
abstract class Students_abstract {
	...
	public Students_abstract(){		//생성자 오버로드	매개변수 없는 생성자
		p_id = "";
		p_name= "";
		p_sex="";
		p_age=0;
	...
	public Students_abstract(String p_id, String p_name, String p_sex, int p_age, String adress){	//생성자 오버로드	매개변수를 받는 생성자
		this.p_id = p_id;
		this.p_name = p_name;
		this.p_sex = p_sex;
		this.p_age = p_age;
	...
	public abstract void print_ans();																			//추상클래스
